...
class Stash:
    ...
    def set_homography_matrix(self, homography_matrix: np.ndarray, homography_matrix_status: bool):
        self._homography_matrix = homography_matrix
        self._homography_matrix_status = homography_matrix_status

    def get_homography_matrix(self) -> tuple[np.ndarray, bool]:
        return self._homography_matrix, self._homography_matrix_status
